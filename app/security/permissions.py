...
def require_project_membership(project_id: int, roles: tuple[str, ...] | None = None):
    ...
    Args:
        ...
        roles: Jeśli podane, użytkownik musi mieć jedną z tych ról
    
    Returns:
        Rola użytkownika w projekcie
    
    Raises:
        HTTP 404 - jeśli użytkownik nie ma dostępu (ukrycie zasobu)
        HTTP 403 - jeśli rola jest niewystarczająca
    """
